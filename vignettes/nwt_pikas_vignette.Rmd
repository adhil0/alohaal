...
s.sf.gcs <- st_transform(test$geometry, "+proj=longlat +datum=WGS84")
ggmap(get_stamenmap(nwt, zoom = 11, maptype = "terrain")) + #geom_point(data = nwt_pikas, aes(
#  x = easting,
#  y = northing,
#  color = local_site,
#  alpha = 1)) 
geom_sf(data = s.sf.gcs, alpha = 0.3, inherit.aes = FALSE)
