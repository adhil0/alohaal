#' North Temperate Lakes LTER: Ice Duration - Madison Lakes Area 1853 - current & Madison Wisconsin Daily Meteorological Data 1869 - current
#'
...
#'   \item{ice_off}{a Date denoting the breakup date of each lake}
